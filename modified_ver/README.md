...
## Note
- Input file format has been changed from text to Fasta (2025/09/10).  
...
1. Find candidate regions for generating probes for the target mRNA (First_ver3.1.R).
...
 
## V. Overview of the First_ver3.1.R program
 
<p align="center">
...
 
## VI. Procedure for the First_ver3.1.R program
1. The DNA sequence of the target mRNA is downloaded and saved as a fasta file.
2. Open “First_ver3.1.R”, and the file name is written with an absolute path in “LoadFileName”.
